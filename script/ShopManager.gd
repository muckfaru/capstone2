...
const CATALOG: Array[Dictionary] = [
	...
	{
		"id": "bg_dt_asteroid_belt",
		"name": "Asteroid Belt Graveyard",
		"category": "background",
		"price": 120,
		"icon_path": "res://asset/background/Asteroid Belt Graveyard.png",
		"slot": "equipped_bg_defuse_trojan",
		"apply_value": "res://asset/background/Asteroid Belt Graveyard.png",
		"rarity": "rare",
		"description": "Destroyed spacecraft debris drifts through a jagged asteroid field.",
		"default": false,
	},
	{
		...
		"rarity": "epic",
		"description": "Twin suns cast contrasting light across a dense, warping starfield.",
		"default": false,
	},
		{
		"id": "bg_dt_corrupted_void",
		"name": "Corrupted Data Void",
		"category": "background",
		"price": 200,
		"icon_path": "res://asset/background/Corrupted Data Void.png",
		"slot": "equipped_bg_defuse_trojan",
		"apply_value": "res://asset/background/Corrupted Data Void.png",
		"rarity": "epic",
		"description": "Fragmented hexagonal grids glitch in a purple-black void.",
		"default": false,
	},
		{
		"id": "bg_dt_frozen_nebula",
		"name": "Frozen Nebula",
		"category": "background",
		"price": 150,
		"icon_path": "res://asset/background/Frozen Nebula.png",
		"slot": "equipped_bg_defuse_trojan",
		"apply_value": "res://asset/background/Frozen Nebula.png",
		"rarity": "rare",
		"description": "Crystalline ice formations refract starlight in a cold nebula.",
		"default": false,
	},
		{
		"id": "bg_dt_supernova",
		...
		"category": "background",
		"price": 250,
		"icon_path": "res://asset/background/Supernova Remnant.png",
		"slot": "equipped_bg_defuse_trojan",
		"apply_value": "res://asset/background/Supernova Remnant.png",
		"rarity": "legendary",
		"description": "An expanding shockwave of orange-gold energy from a massive stellar explosion.",
		"default": false,
	},
	# Akashic TCG
	{
	...
	{
		"id": "bg_atcg_enchanted_library",
		"name": "Enchanted Library",
		"category": "background",
		"price": 150,
		"icon_path": "res://asset/background/Enchanted Library.png",
		"slot": "equipped_bg_akashic_tcg",
		"apply_value": "res://asset/background/Enchanted Library.png",
		"rarity": "rare",
		"description": "Towering bookshelves and floating magical orbs illuminate ancient tomes.",
		"default": false,
	},
		{
		"id": "bg_atcg_crystal_sanctum",
		"name": "Crystal Sanctum",
		"category": "background",
		"price": 200,
		"icon_path": "res://asset/background/Crystal Sanctum.png",
		"slot": "equipped_bg_akashic_tcg",
		"apply_value": "res://asset/background/Crystal Sanctum.png",
		"rarity": "epic",
		"description": "Enormous translucent crystals emit soft inner light in an underground cavern.",
		"default": false,
	},
	{
		"id": "bg_atcg_celestial",
		"name": "Celestial Observatory",
		"category": "background",
		"price": 150,
		"icon_path": "res://asset/background/Celestial Observatory.png",
		"slot": "equipped_bg_akashic_tcg",
		"apply_value": "res://asset/background/Celestial Observatory.png",
		"rarity": "rare",
		"description": "A cosmic observatory arena.",
		"default": false,
	},
	{
		"id": "bg_atcg_volcanic_forge",
		"name": "Volcanic Forge",
		"category": "background",
		"price": 200,
		"icon_path": "res://asset/background/Volcanic Forge.png",
		"slot": "equipped_bg_akashic_tcg",
		"apply_value": "res://asset/background/Volcanic Forge.png",
		"rarity": "epic",
		"description": "Rivers of molten lava flow through an obsidian forge chamber.",
		"default": false,
	},
	{
		"id": "bg_atcg_spirit_gateway",
		"name": "Spirit Realm Gateway",
		"category": "background",
		"price": 250,
		"icon_path": "res://asset/background/Spirit Realm Gateway.png",
		"slot": "equipped_bg_akashic_tcg",
		"apply_value": "res://asset/background/Spirit Realm Gateway.png",
		"rarity": "legendary",
		"description": "A glowing portal arch of intertwined roots opens to the spirit realm.",
		"default": false,
	},
	# Code Breaker
	{
	...
	{
		"id": "bg_cb_server_room",
		"name": "Server Room Abyss",
		"category": "background",
		"price": 150,
		"icon_path": "res://asset/background/Server Room Abyss.png",
		"slot": "equipped_bg_code_breaker",
		"apply_value": "res://asset/background/Server Room Abyss.png",
		"rarity": "rare",
		"description": "Endless server racks with blinking LEDs and glowing fiber optics.",
		"default": false,
	},
	{
		"id": "bg_cb_holo_command",
		"name": "Holographic Command Center",
		"category": "background",
		"price": 200,
		"icon_path": "res://asset/background/Holographic Command Center.png",
		"slot": "equipped_bg_code_breaker",
		"apply_value": "res://asset/background/Holographic Command Center.png",
		"rarity": "epic",
		"description": "Floating holographic displays cast teal light across a tactical command room.",
		"default": false,
	},
		{
		"id": "bg_cb_neural_matrix",
		"name": "Neural Network Matrix",
		"category": "background",
		"price": 200,
		"icon_path": "res://asset/background/Neural Network Matrix.png",
		"slot": "equipped_bg_code_breaker",
		"apply_value": "res://asset/background/Neural Network Matrix.png",
		"rarity": "epic",
		"description": "Glowing nodes and pulsing energy lines form an infinite neural network.",
		"default": false,
	},
	{
		"id": "bg_cb_bunker",
		...
		"category": "background",
		"price": 150,
		"icon_path": "res://asset/background/Underground Bunker.png",
		"slot": "equipped_bg_code_breaker",
		"apply_value": "res://asset/background/Underground Bunker.png",
		"rarity": "rare",
		"description": "A dimly lit bunker with CRT monitors and cold-war hacker vibes.",
		"default": false,
	},
		{
		"id": "bg_cb_digital_rain",
		"name": "Digital Rain Cityscape",
		"category": "background",
		"price": 250,
		"icon_path": "res://asset/background/Digital Rain Cityscape.png",
		"slot": "equipped_bg_code_breaker",
		"apply_value": "res://asset/background/Digital Rain Cityscape.png",
		"rarity": "legendary",
		"description": "Neon-lit cyberpunk skyline with Matrix-style digital rain.",
		"default": false,
	},
