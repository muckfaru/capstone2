...
func _ready() -> void:
	...
	leave_normal.corner_radius_top_right = 40
	leave_normal.corner_radius_top_left = 10
	leave_normal.corner_radius_bottom_right = 10
	leave_normal.corner_radius_bottom_left = 40
